...
data class Item(
    ...
    val hasteResourceType: String ="", // e.g., "spirit", "monk", "treasure"
...
data class GameResources(
    ...
    val hasteSpirit: MutableState<Int> = mutableStateOf(0),
    val hasteMonk: MutableState<Int> = mutableStateOf(0),
...
//    var isPanelExpanded: MutableState<Boolean> = mutableStateOf(false)
    ...
    val resourceMap: Map<String, MutableState<Int>> = mapOf(
        "spirit" to spirit,
        "prowess" to prowess,
        "hasteSpirit" to hasteSpirit,
        "hasteMonk" to hasteMonk,
